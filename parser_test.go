				...
				Steps: []Step{
					{
						...
						Timers:      []Timer{},
						Cookware: []Cookware{
							{Name: "stove", Quantity: 1, IsNumeric: false, Idx: 24},
							{Name: "standing mixer", Quantity: 1, IsNumeric: false, Idx: 45},
							{Name: "fork", Quantity: 2, QuantityRaw: "2", IsNumeric: true, Idx: 63},
							{Name: "frying pan", Quantity: 1, QuantityRaw: "three", IsNumeric: false, Idx: 78},
							{Name: "frying pot", Quantity: 1, QuantityRaw: "two small", IsNumeric: false, Idx: 92},
						},
					},
				},
				Metadata: make(Metadata),
				...
				Steps: []Step{
					{
						...
						Ingredients: []Ingredient{
							...
							{Name: "salt", Amount: IngredientAmount{true, 24.6, "24.6", "g"}, Idx: 49},
							{Name: "fresh yeast", Amount: IngredientAmount{true, 1.6, "1.6", "g"}, Idx: 58},
						},
						Cookware: []Cookware{{Name: "fridge", Quantity: 1, IsNumeric: false, QuantityRaw: "", Idx: 80}},
					},
					{
						...
						Cookware: []Cookware{
							...
							{Name: "pizza stone", Quantity: 1, IsNumeric: false, QuantityRaw: "", Idx: 37},
						},
					},
					{
						...
						Ingredients: []Ingredient{
							...
							{Name: "dried oregano", Amount: IngredientAmount{true, 3, "3", "tbsp"}, Idx: 58},
						},
						Cookware: []Cookware{{Name: "pan", Quantity: 1, IsNumeric: false, QuantityRaw: "", Idx: 82}},
					},
					{
						...
						Timers:     []Timer{},
						Ingredients: []Ingredient{
							{Name: "fresh basil", Amount: IngredientAmount{true, 18, "18", "leaves"}, Idx: 80},
							{Name: "parma ham", Amount: IngredientAmount{true, 3, "3", "packs"}, Idx: 93},
							{Name: "mozzarella", Amount: IngredientAmount{true, 3, "3", "packs"}, Idx: 107},
						},
						Cookware: []Cookware{{Name: "spoon", Quantity: 1, IsNumeric: false, QuantityRaw: "", Idx: 43}},
					},
					{
